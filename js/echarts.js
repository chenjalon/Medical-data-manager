...
define('echarts/component/markArea', ['require', './marker/MarkAreaModel', './marker/MarkAreaView', '../echarts'], function (require) {
...
define('echarts/component/marker/MarkAreaView', ['require', 'zrender/core/util', '../../data/List', '../../util/number', '../../util/graphic', 'zrender/tool/color', './markerHelper', './MarkerView'], function (require) {
    var zrUtil = require('zrender/core/util');
...
define('echarts/component/marker/MarkAreaModel', ['require', './MarkerModel'], function (require) {
