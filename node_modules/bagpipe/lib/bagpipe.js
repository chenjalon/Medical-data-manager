...
Bagpipe.prototype.pause = function() { this.paused = true };
Bagpipe.prototype.resume = function() { this.paused = false; this.next() };
...
Bagpipe.prototype.run = function (method, args) {
  ...
  setTimeout(function() { method.apply(null, args) }, 0);
};
